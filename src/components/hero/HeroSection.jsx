...
export default function HeroSection() {
    return (
        <section id="hero" className="relative overflow-hidden pb-20 pt-34 md:pb-28 md:pt-40">
            ...
            <div className="container-custom relative z-10">
                <div className="mx-auto max-w-5xl text-center">
                    ...
                    <h1 className="animate-rise mt-7 text-4xl font-bold leading-tight tracking-tight text-ink-100 sm:text-5xl lg:text-6xl" style={{ animationDelay: '0.08s' }}>
                        Trade With A
                        <span className="gradient-text block">Controlled AI Workflow</span>
                    </h1>

                    <p className="animate-rise mx-auto mt-6 max-w-2xl text-base leading-relaxed text-ink-300 sm:text-lg" style={{ animationDelay: '0.16s' }}>
                ...
                <div className="mt-11 grid gap-4 md:grid-cols-3">
                    <div className="glass-card glass-card-hover animate-rise p-5" style={{ animationDelay: '0.2s' }}>
                        ...
                        <p className="mt-1 text-sm text-ink-400">News and chart signals are fused into one confidence score.</p>
                    </div>

                    <div className="glass-card glass-card-hover animate-rise p-5" style={{ animationDelay: '0.3s' }}>
                        ...
                        <p className="mt-1 text-sm text-ink-400">Strategies can switch behavior by volatility and market session.</p>
                    </div>

                    <div className="glass-card glass-card-hover animate-rise p-5" style={{ animationDelay: '0.4s' }}>
                        ...
                        <p className="mt-1 text-sm text-ink-400">Daily loss caps, stop chains, and API safeguards are built in.</p>
                    </div>
                </div>
            </div>
        </section>
